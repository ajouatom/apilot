...
void drawLeadApilot(const UIState* s) {
    ...
    case 1: strcpy(strDrivingMode, "ECO"); break;// "연비"; break;
    case 2: strcpy(strDrivingMode, "SAFE"); break;// "안전"; break;
    case 3: strcpy(strDrivingMode, "NOR"); break;// "일반"; break;
    case 4: strcpy(strDrivingMode, "SPD"); break;// "고속"; break;
    }
