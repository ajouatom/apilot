...
CommunityPanel::CommunityPanel(QWidget* parent) : QWidget(parent) {
  ...
  toggleLayout->addWidget(new CValueControl("ShowPathMode", "화면:패스표시모드", "", "../assets/offroad/icon_shell.png", 0, 10, 1));
  toggleLayout->addWidget(new CValueControl("ShowPathColor", "화면:패스표시색상", "", "../assets/offroad/icon_shell.png", 0, 19, 1));
  toggleLayout->addWidget(new CValueControl("ShowPathModeLane", "화면:패스표시모드,레인모드", "", "../assets/offroad/icon_shell.png", 0, 10, 1));
