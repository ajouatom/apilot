...
def driverview(started: bool, params: Params, CP: car.CarParams) -> bool:
  return dp_dm and (started or params.get_bool("IsDriverViewEnabled"))
...
procs = [
  ...
  PythonProcess("dmonitoringmodeld", "selfdrive.modeld.dmonitoringmodeld", driverview, enabled=(not PC or WEBCAM) and dp_dm),
  ...
  PythonProcess("dmonitoringd", "selfdrive.monitoring.dmonitoringd", driverview, enabled=(not PC or WEBCAM) and dp_dm),
  ...
  PythonProcess("dpmonitoringd", "selfdrive.dragonpilot.dpmonitoringd", only_onroad, enabled=not dp_dm),
]
