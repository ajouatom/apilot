...
class VCruiseHelper:
  def __init__(self, CP):
    self.CP = CP
    self.v_cruise_kph = 30 #V_CRUISE_UNSET
    self.v_cruise_cluster_kph = 30 #V_CRUISE_UNSET
...
def get_lag_adjusted_curvature(CP, v_ego, psis, curvatures, curvature_rates, distances, steerActuatorDelay):
  ...
  delay = steerActuatorDelay


  average_desired_curvature = Params().get_bool("AverageCurvature")
