...
def plannerd_thread(sm=None, pm=None):
  ...
  if sm is None:
    sm = messaging.SubMaster(['carControl', 'carState', 'controlsState', 'radarState', 'modelV2', 'sensorEvents'],
                             poll=['radarState', 'modelV2', 'sensorEvents'], ignore_avg_freq=['radarState'])
